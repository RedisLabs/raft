...
void* __set_up()
{
    ...
    raft_log_set_callbacks(raft_get_log(r), &raft_log_funcs, r);
    return r;
}
...
void TestLog_delete(CuTest * tc)
{
    ...
    l = raft_log_new();
    raft_log_set_callbacks(l, &raft_log_funcs, r);
...
void T_estlog_cant_append_duplicates(CuTest * tc)
{
    ...
    l = raft_log_new();
    CuAssertTrue(tc, 1 == raft_log_append_entry(l, &e));
    CuAssertTrue(tc, 1 == raft_log_count(l));
}
#endif
